...
@mcp.tool()
def add_memory(entity: str, aspect: str, text: str, salience: int = 5, file_path: str = None) -> str:
    """
    ...
    """
    row_id = core.add_fact(entity, aspect, text, salience, file_path=file_path)
    if row_id == -1:
