...
2. **The Briefing Protocol:** Your first action in ANY session must be to run `get_context("GLOBAL")` for identity and `get_context(PROJECT_NAME)` to synchronize your world model.
